...
1. `cd site`
2. `node po en_US --module=RealEstate`

Replace `en_US` with a language code you need to translate to.
...
1. `cd site`
2. `node lang en_US --module=RealEstate`

Replace `en_US` with the target language code.
